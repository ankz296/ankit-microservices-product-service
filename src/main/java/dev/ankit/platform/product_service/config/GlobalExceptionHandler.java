...
import dev.ankit.platform.product_service.exception.BusinessException;
import dev.ankit.platform.product_service.exception.ErrorResponse;
...
@Slf4j
@RestControllerAdvice(basePackages = "dev.ankit.platform.product_service")
